  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold uppercase tracking-wider transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        liquor: 'border-transparent bg-amber text-white',
        mixer: 'border-2 border-amber-dark/30 bg-cream text-wood-brown',
        wine: 'border-transparent bg-burgundy text-white',
      },
    },
    defaultVariants: {
      variant: 'default',
